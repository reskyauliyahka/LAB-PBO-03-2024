...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndeks != -1) {
            ...
            do {
                ...
                */
                isPasswordMatch = listUser.get(userIndeks).getPassword().equals(password);
                ...
                if (isPasswordMatch) {
                    ...
                    * 
                    */
                    showDetailUser(listUserProfile.get(userIndeks));
                    System.exit(0);
                } else {
    ...
    private static void showRegisterMenu() {
        ...
        boolean usernameExits;
        do {
            usernameExits = false;
            for (User user: listUser) {
                if(user.getUsername().equals(username)) {
                    System.out.println("Username sudah digunakan, gunakan username lain");
                    System.out.print("> ");
        ...
        do {
            try {
                ...
                System.out.println("Masukkan umur dalam bentuk angka");
                sc.nextLine();
            }
        } while (!validAge);
